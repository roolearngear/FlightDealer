...
window.onload = function() {
    ...
    document.getElementById('skyscanner').onclick = function() {
        ...
        var url = 'https://www.skyscanner.com.tw/transport/flights/' + departure + '/' + arrival + '/' + date + '/airfares-from-' + full_departure + '-to-' + full_arrival + '-in-' + monthyear + '.html?adults=1&children=0&infants=0&cabinclass=economy&rtn=0&preferdirects=true&outboundaltsenabled=false&inboundaltsenabled=false#results';
...
function post_to_url() {
    url = 'http://gessl.tna.com.tw/Search/Search';
    var data = {
        SearchFlights: [{
                Direction: "OneWay",
                DepartureStationCode: "MZG",
                ArrivalStationCode: "TSA",
                DepartureDate: "2016/07/10"
            }
